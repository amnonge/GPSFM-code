...
% Last modified by D. Henrion on 29 November 2013
...
while ~fail & (i < nvar)
 ...
 if ~fail
  if length(mind) == size(U,2)
   N{i} = U(mind,:);
  else
   fail = true; % incorrect evaluation of number of monomials
  end
 end;
end; 
